bonjourfoxy.servicetypes = {
    lookup: function(query) {
        /* accept _service._proto or service */
        var type = query.replace(/^_(.*)._.*$/, "$1");
        return bonjourfoxy.servicetypes.services[type] || "Unknown";
    },
    /*
    Generated by copying the list from
    http://www.dns-sd.org/ServiceTypes.html
    and running it through:
    grep -e '^[a-z0-9-].*' | \
    sed -e 's/"/\\"/g' -e 's/^\([a-z0-9-]*\)\ *\(.*\)/"\1": "\2",/g'
    */
    services: {
